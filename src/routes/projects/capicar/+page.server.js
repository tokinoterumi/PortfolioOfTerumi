...
export async function load() {
	try {
		...
		const markdownModuleEn = await import('$lib/data/project-content/capicar-case-study.md?raw');
		const markdownModuleJa = await import('$lib/data/project-content/capicar-case-study-ja.md?raw');
