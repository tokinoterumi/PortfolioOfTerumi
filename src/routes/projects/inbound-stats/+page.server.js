...
export async function load() {
	try {
		// Get project data
		const project = getProjectBySlug('inbound-stats');

		// Import both English and Japanese markdown files
		const markdownModuleEn = await import('$lib/data/project-content/inbound-stats-case-study.md?raw');
		const markdownModuleJa = await import('$lib/data/project-content/inbound-stats-case-study-ja.md?raw');
